...
const footerLinks = {
  product: [
    ...
    { href: "https://apps.apple.com/app/bubly-social-assistant/id6754884488", label: "Download App", external: true },
  ],
  support: [
...
export const Footer = () => {
  return (
    <footer className="relative mt-auto pt-12 md:pt-20 pb-6 md:pb-8 overflow-hidden">
        ...
        <div className="md:hidden">
          ...
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center gap-2 mb-3 group">
              ...
              />
              <span className="text-xl font-bold gradient-text">Bubly</span>
            </Link>
            <p className="text-muted-foreground text-xs leading-relaxed">
              Your intelligent social assistant.<br />
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            <div>
              <h4 className="font-semibold text-xs mb-2 text-foreground">Product</h4>
            ...
            <div>
              <h4 className="font-semibold text-xs mb-2 text-foreground">Support</h4>
              <ul className="space-y-1.5">
            ...
            <div>
              <h4 className="font-semibold text-xs mb-2 text-foreground">Legal</h4>
              <ul className="space-y-1.5">
          ...
          <div className="pt-4 border-t border-border/50 flex flex-col items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-300 flex items-center gap-1.5"
            >
